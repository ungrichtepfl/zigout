...
**NOTE**: zig version 0.11.x is needed. May work with higher versions.
...
there on instructions how to build and run it (run the build commands in that folder then).
